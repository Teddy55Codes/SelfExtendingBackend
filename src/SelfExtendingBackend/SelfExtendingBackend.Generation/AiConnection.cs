...
{
    private static readonly string FixInstructionPart1 =
        "After running the generated code, I encountered the following build error:";

    private static readonly string FixInstructionPart2 =
        "Please analyze the build error and fix the code accordingly, ensuring the error is resolved while maintaining adherence to the original requirements. Return the updated C# code and JSON in the same format as specified above.";


    private static readonly string GenerateCodeInstruction = """
    ...
    {
        ChatCompletion completion = Client.CompleteChat(_chatMessages, _options);
